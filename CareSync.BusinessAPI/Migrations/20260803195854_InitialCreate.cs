    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    AppointmentNumber = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), new DateTime(2026, 8, 3, 19, 58, 54, 655, DateTimeKind.Utc).AddTicks(825), "Heart Department", false, "Cardiology", null },
                    { new Guid("22222222-2222-2222-2222-222222222222"), new DateTime(2026, 8, 3, 19, 58, 54, 655, DateTimeKind.Utc).AddTicks(830), "Brain Department", false, "Neurology", null },
                    { new Guid("33333333-3333-3333-3333-333333333333"), new DateTime(2026, 8, 3, 19, 58, 54, 655, DateTimeKind.Utc).AddTicks(900), "Bone Department", false, "Orthopedics", null },
                    { new Guid("44444444-4444-4444-4444-444444444444"), new DateTime(2026, 8, 3, 19, 58, 54, 655, DateTimeKind.Utc).AddTicks(903), "Skin Department", false, "Dermatology", null }
                });
